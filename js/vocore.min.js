$(function() {
    ...
    function trace(id) {
        ...
        email =  $("#edTrace").val();
        $.getJSON("http://vocore.io/cgi-bin/trace?email=" + email + "&index=" + id, function(json) {
            if (id === 0)
                $("#lbTraceInfo").html("");
            if (json.status === "empty") {
                if (id === 0)
                    $("#lbTraceInfo").html("<h5>Sorry, no record yet.</h5>");
            ...
            if (json.status === "completed" || json.status === "shipped") {
                ...
                cur += "Trace ID: <font color='#F80'><b>" + json.trace + "</b></font></small></h5>";
            } else {
