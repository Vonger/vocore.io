$(function() {
  var i, j, k, count = 0;
  var country, cost1, cost2, countries_name = "", countries_code = "";
  ...
  function update() {
      ...
      if (cost1 === cost2) {
          $("#rbShipping1").attr("checked", "checked");
      ...
      if ($("#rbShipping1").prop("checked")) {
          carrier = "post";
          // free shipping, ignore cost1.
          ship = 0;
      } else {
          carrier = "express";
          ship = parseFloat(cost2) + total * 0.05;
